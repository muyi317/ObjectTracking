...
__C.DATASET.NAMES =('VID', 'COCO', 'DET', 'YOUTUBEBB', 'Virtual', 'Real')
# __C.DATASET.NAMES =('VID',) # ('VID', 'COCO', 'DET', 'YOUTUBEBB')

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = 'F:/det/crop511'          # VID dataset path
__C.DATASET.VID.ANNO = 'F:/det/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.Virtual = CN()
__C.DATASET.Virtual.ROOT = 'F:/Datasets/RobotVision/VirtualImg/crop511'          # VID dataset path
__C.DATASET.Virtual.ANNO = 'F:/Datasets/RobotVision/VirtualImg/train.json'
__C.DATASET.Virtual.FRAME_RANGE = 30
__C.DATASET.Virtual.NUM_USE = 64000  # repeat until reach NUM_USE

__C.DATASET.Real = CN()
__C.DATASET.Real.ROOT = 'F:/Datasets/RobotVision/RealImg/crop511'          # VID dataset path
__C.DATASET.Real.ANNO = 'F:/Datasets/RobotVision/RealImg/train.json'
__C.DATASET.Real.FRAME_RANGE = 30
__C.DATASET.Real.NUM_USE = 64000  # repeat until reach NUM_USE
...
#(2) 需要修改
__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = 'F:/Datasets/DET/crop511'           # DET dataset path
__C.DATASET.DET.ANNO = 'F:/Datasets/DET/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1

__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'F:/Datasets/GOT-10k/crop511'         # GOT dataset path
__C.DATASET.GOT.ANNO = 'F:/Datasets/GOT-10k/train.json'
